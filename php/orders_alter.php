  ...
  <ul class="list-group">
    ...
    <li class="list-group-item"><?php echo $secondClass ?></li>
      ...
      <p><span class="error">* 必填字段</span></p>
           ...
           <div class="controls"><input class = "form-control" id="inputName" placeholder="Name" type="text" name="id" value="<?php echo $id ?>" readonly="readonly" ></div>
           </div>
        ...
        <!-- <tr><th>用户名:</th><td><input type="text" name="id" size="5" value="<?php echo $id?>" readonly="readonly"></td></tr> -->
          ...
          <div class="controls"><input class = "form-control" id="inputTrain" placeholder="Train No" type="text" name="train" value="<?php echo $train ?>" readonly="readonly" ></div>
          </div>
        ...
        <div class="control-group"><label class="control-label"  for="inputDate">日期</label>
            ...
            <div class="controls"><input class = "form-control" id="inputDate" placeholder="Date" type="text" name="date" value="<?php echo $date ?>" readonly="readonly" ></div>
            </div>
        ...
        <div class="control-group"><label class="control-label"  for="inputTime1">出发时间</label>
            ...
            <div class="controls"><input class = "form-control" id="inputTime1" placeholder="Start Time" type="text" name="time1" value="<?php echo $time1 ?>" readonly="readonly" ></div>
            </div>
        ...
        <div class="control-group"><label class="control-label"  for="inputTime2">到达时间</label>
            ...
            <div class="controls"><input class = "form-control" id="inputTime2" placeholder="End Time" type="text" name="time2" value="<?php echo $time2 ?>" readonly="readonly" ></div>
            </div>
            </div>
    <div class="col-md-4 " >
        <p></p>
        ...
        <div class="control-group"><label class="control-label"  for="inputSrc">出发地</label>
            ...
            <div class="controls"><input class = "form-control" id="inputSrc" placeholder="Departure" type="text" name="src" value="<?php echo $src ?>" readonly="readonly" ></div>
            </div>
        ...
        <div class="control-group"><label class="control-label"  for="inputDest">目的地</label>
            ...
            <div class="controls"><input class = "form-control" id="inputDest" placeholder="Destination" type="text" name="dest" value="<?php echo $dest ?>" readonly="readonly" ></div>
            </div>
