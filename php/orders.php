...
<?php
  ...
  foreach($data as $key => $value){
        ...
        echo "<td>{$arr[7]}</td>";
        echo "<td>{$arr[8]}</td>";
        echo "<td> <a href='orders_alter_manager.php?id={$arr[0]}&train={$arr[1]}&date={$arr[2]}&time1={$arr[3]}&time2={$arr[4]}&src={$arr[5]}&dest={$arr[6]}&carriage={$arr[7]}&seat={$arr[8]}'
        >修改</a></td>";
